...
| [`dolphin_memoryScanStart`](capabilities.md#dolphin_memoryscanstart) | Start an asynchronous typed numeric or raw-byte memory scan from a consistent snapshot. |
